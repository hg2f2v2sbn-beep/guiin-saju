...
INSERT OR IGNORE INTO service_state(state_key,state_value,updated_at,updated_by) VALUES
  ('MAINTENANCE_MODE','false',datetime('now'),'bootstrap'),
  ('READ_ONLY_MODE','false',datetime('now'),'bootstrap'),
  ('AI_DISABLED','false',datetime('now'),'bootstrap'),
  ('PAYMENTS_DISABLED','true',datetime('now'),'bootstrap');
